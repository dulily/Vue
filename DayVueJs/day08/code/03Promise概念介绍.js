// 在控制台通过 console.dir(Promise) 查看 Promise 是什么
// console.dir() 可以显示一个对象所有的属性和方法

// Promise 基本概念的介绍

// 1.Promise 是一个 构造函数，既然是构造函数，那么，我们就可以，new Promise() 得到一个 Promise 实例；
...
// 6.我们可以在 new 处理的 Promise 实例上，调用 .then() 方法，【预先】为这个 Promise 异步操作，指定，成功(resolve) 和 失败(reject) 回调函数。
...
// 也就是说，new 的时候，除了能够得到 一个 Promise 实例之外，还会立即调用 我们为 Promise 构造函数传递的那个 function ，执行这个 function 中的异步操作代码。
// var promise = new Promise(function() {
